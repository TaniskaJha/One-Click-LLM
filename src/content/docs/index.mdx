...
## Streamling LLM Inference API Deployment on any cloud plaform via Ollama, vLLM and Llama-cpp
...
2. Hit Deploy to get a properly configured compose file with inference api of the selected model.
